...
public class Product {//商品
	...
	private String imgAddr;//图片
	private String normalPrice;//原价
	private String promotionPrice;//折扣价
	private Integer priority;//权重
	private Date createTime;//创建时间
	private Date lastEditTime;//更新时间
	private Integer enableStatus;//状态，0：下架；1：能在前端展示系统展示
	private List<ProductImg> productImgList;//对应商品图片集合
	private ProductCategory productCategory;//对应商品类别
